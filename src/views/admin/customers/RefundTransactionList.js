...
export default function WalletTransactions() {
    ...
    const fetchWalletTransactions = (search) => {
        axios.get(`/customers/${customerId}/refund-transaction-list?search=${search}`, {
            headers: {
                Authorization: token
            }
        }).then(response => {
        ...
        <>
            <div className="px-8 mt-8 mb-8">
                <div className="page-heading">
                    <h1 className="pageHeading">Customer Refund Transctions</h1>
                    <div className="flex">
                ...
                <div className="border-b">
                    ...
                    <div className="w-full mb-2">
                        <h4 className="pageHeading">Refund Transctions List</h4>
                    </div>
                    <input
                    ...
                    <table className="w-full">
                        <thead>
                            <tr className="border-b h-12">
                                ...
                                <th className="tableHeader">Payment Method</th>
                                <th className="tableHeader">Transaction Number</th>
                        ...
                        <tbody>
                            {walletTransactions.data?.map((walletTransaction, index) => (
                                <tr className="border-b py-4 h-20">
                                    ...
                                    <td className="tableData">{walletTransaction.payment_method}</td>
                                    <td className="tableData">{walletTransaction.transaction_number}</td>
