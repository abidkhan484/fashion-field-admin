...
export default function EditSupplier() {
    ...
    const [currentRegisteredNameDoc, setCurrentRegisteredNameDoc] = useState(null)

    const [incorporationNo, setIncorporationNo] = useState("")
    const [incorporationNoDoc, setIncorporationNoDoc] = useState(null)
    const [currentIncorporationNoDoc, setCurrentIncorporationNoDoc] = useState(null)

    const [tradeLicenseNumber, setTradeLicenseNumber] = useState("")
    const [tradeLicenseNumberDoc, setTradeLicenseNumberDoc] = useState(null)
    const [currentTradeLicenseNumberDoc, setCurrentTradeLicenseNumberDoc] = useState(null)

    const [vatRegistrationNumber, setVatRegistrationNumber] = useState("")
    const [vatRegistrationNumberDoc, setVatRegistrationNumberDoc] = useState(null)
    const [currentVatRegistrationNumberDoc, setCurrentVatRegistrationNumberDoc] = useState(null)
    ...
    const [currentECabMembershipDoc, setCurrentECabMembershipDoc] = useState(null)

    const [basisMembership, setBasisMembership] = useState("")
    const [basisMembershipDoc, setBasisMembershipDoc] = useState(null)
    const [currentBasisMembershipDoc, setCurrentBasisMembershipDoc] = useState(null)
    ...
    React.useEffect(() => {
        if (user?.permissions) {
            if (!(permission(user.permissions, 'supplier_management', 'update')) && (user.user_type_id != 1))
                history.push('/admin');
        }
    }, [user])
        ...
        if (token !== '') {
            axios.get(`/suppliers/${id}`, {
                ...
                .then(response => {
                    ...
                    response.data.store?.purchase_method ? setPurchaseMethod({ value: response.data.store?.purchase_method, label: response.data.store?.purchase_method }) : setPurchaseMethod(null)
                    ...
                    setVatRegistrationNumber(response.data?.vat_registration_no)
                    ...
                    setCurrentIncorporationNoDoc(response.data?.incorporate_docu)
                    setCurrentRegisteredNameDoc(response.data?.registered_docu)
                    setCurrentTradeLicenseNumberDoc(response.data?.trade_license_docu)
                    setCurrentVatRegistrationNumberDoc(response.data?.vat_reg_docu)
    ...
    const changeActication = () => {
        ...
        axios.post(`/suppliers/store/${store.id}/activation`, {
            status: !store.status
        }, {
            headers: {
                Authorization: token
    ...
    return (
        <div className="mb-8">
            <div className="px-8 mt-8 mb-4 flex justify-between">
                <p className="font-Poppins font-medium text-base text-pageHeading">Update Supplier</p>
                {store ? (
                    <>
                        {
            ...
            <div className="grid grid-cols-12 px-8 gap-8">
                                    ...
                                    <div className='grid grid-cols-12'>
                                        ...
                                        <div className='col-span-4'>
                                            <div className='flex justify-center items-center h-full'>
                                                {
                                                    currentRegisteredNameDoc ? <a href={currentRegisteredNameDoc} target="_blank">Existing Document</a> : <p>No Documents Available</p>
                                                }
                                            </div>
                                        </div>
                                ...
                                <div className="col-span-8">
                                    <div className='grid grid-cols-12'>
                                        ...
                                        <div className='col-span-4'>
                                            <div className='flex justify-center items-center h-full'>
                                                {
                                                    currentIncorporationNoDoc ? <a href={currentIncorporationNoDoc} target="_blank">Existing Document</a> : <p>No Documents Available</p>
                                                }
                                            </div>
                                        </div>
                                ...
                                <div className="col-span-8">
                                    <div className='grid grid-cols-12'>
                                        ...
                                        <div className='col-span-4'>
                                            <div className='flex justify-center items-center h-full'>
                                                {
                                                    currentTradeLicenseNumberDoc ? <a href={currentTradeLicenseNumberDoc} target="_blank">Existing Document</a> : <p>No Documents Available</p>
                                                }
                                            </div>
                                        </div>
                                ...
                                <div className="col-span-8">
                                    <div className='grid grid-cols-12'>
                                        ...
                                        <div className='col-span-4'>
                                            <div className='flex justify-center items-center h-full'>
                                                {
                                                    currentVatRegistrationNumberDoc ? <a href={currentVatRegistrationNumberDoc} target="_blank">Existing Document</a> : <p>No Documents Available</p>
                                                }
                                            </div>
                                        </div>
                                ...
                                <div className="col-span-8">
                                    <div className='grid grid-cols-12'>
                                        ...
                                        <div className='col-span-4'>
                                            <div className='flex justify-center items-center h-full'>
                                                {
                                                    currentETinDoc ? <a href={currentETinDoc} target="_blank">Existing Document</a> : <p>No Documents Available</p>
                                                }
                                            </div>
                                        </div>
                                ...
                                <div className="col-span-8">
                                    <div className='grid grid-cols-12'>
                                        ...
                                        <div className='col-span-4'>
                                            <div className='flex justify-center items-center h-full'>
                                                {
                                                    currentECabMembershipDoc ? <a href={currentECabMembershipDoc} target="_blank">Existing Document</a> : <p>No Documents Available</p>
                                                }
                                            </div>
                                        </div>
                                ...
                                <div className="col-span-8">
                                    <div className='grid grid-cols-12'>
                                        ...
                                        <div className='col-span-4'>
                                            <div className='flex justify-center items-center h-full'>
                                                {
                                                    currentBasisMembershipDoc ? <a href={currentBasisMembershipDoc} target="_blank">Existing Document</a> : <p>No Documents Available</p>
                                                }
                                            </div>
                                        </div>
                ...
                <div className="col-span-4">
                    <div className="bg-white w-full shadow-md rounded-md">
                        <p className="py-4 border-b pl-8 font-Poppins font-medium text-base text-pageHeading">Supplier Image</p>
                        {(preivew) ? (
                            <>
            ...
            <div className="px-8 mt-8 flex justify-end">
                {(loading) ? (
                    ...
                    <>
                        <button onClick={updateSupplier} className="button button-primary w-32">Update Supplier</button>
                    </>
                )}
