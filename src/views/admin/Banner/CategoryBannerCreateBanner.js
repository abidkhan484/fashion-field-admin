...
const CategoryBannerCreateBanner = () => {
                ...
                <div className="card-body overflow-x-auto">
                    <div className="w-full flex -mx-1">
                        ...
                        <div className="w-1/3 mx-1">
                            ...
                            >
                                <option className="disabled">Select</option>
                                <option className="" value="section1">
                                    Section1
                                </option>
                                <option className="" value="section2">
                                    Section2
                                </option>
                            </select>
                            <p className="text-red-600 text-sm">
                        ...
                        <div className="w-1/3 mx-1">
                            ...
                            <input
                                ...
                                name="image"
                            />
                            <p className="text-sm">Image size: 570x200</p>
                            <p className="text-red-600 text-sm">
                                {errors.image}
                            </p>
                        </div>
...
export default CategoryBannerCreateBanner;
