...
const PayoutHistory = () => {
    ...
    const fetchPayoutPaidHistory = () => {
        axios.get('/payout', {
            ...
            setPayoutHistory(response.data.payoutPaidHistory);
        }).catch(error => {
    ...
    return (
        <div className="px-8 mt-8 mb-8">
                <div className="page-heading">
                    <h1 className="pageHeading">Paid Payout</h1>
                    <div className="flex">
                                        ...
                                        {payoutHistories?.map((item, index) => (
                                            <tr key={index} className="h-12 border-b">
                                                ...
                                                <td>
                                                    ...
                                                    <Link to={`/admin/payoutpaidhistory/${item.id}/edit`} className="text-sm bg-green-600 text-white mx-2 px-2 py-1 rounded"><i className="fas fa-edit"></i></Link>
                                                </td>
